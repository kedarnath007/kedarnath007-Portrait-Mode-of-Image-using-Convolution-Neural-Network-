...
from keras.layers import AtrousConvolution2D, Convolution2D, MaxPooling2D, ZeroPadding2D, Dense
...
def get_frontend(input_width, input_height) -> Sequential:
    ...
    # model.add(Dense(64, activation='relu', name='conv6_1'))

    model.add(Convolution2D(128, 3, 3, activation='relu', name='conv2_1'))
    model.add(Convolution2D(128, 3, 3, activation='relu', name='conv2_2'))
    model.add(MaxPooling2D((2, 2), strides=(2, 2)))
    # model.add(Dense(128, activation='relu', name='conv6_2'))
    ...
    # model.add(Dense(256, activation='relu', name='conv6_3'))
    ...
    model.add(Dense(4096, activation='relu', name='dense_Layer'))
